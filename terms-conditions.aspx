<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="terms-conditions.aspx.cs" Inherits="terms_conditions" %>
        ...
        <div class="container">
            <div class="row align-items-left">
                <div class="col-lg-12 col-sm-6 col-12 px-2 mb-3 mmb-2 text-left thankyou">
                    <h4 class="text-white">Terms & Conditions
                    </h4>
                    <hr>
                </div>
                <hr>
                <div class="col-lg-12 col-sm-6 col-12 px-2" align="justify">
                    <p class="text-white">
                        <strong>OVERVIEW</strong>
                    </p>
                    <p class="text-white">
                        https://shop.joshmart.ai website is operated by joshmart. Throughout the site, the
                        terms “we”, “us” and “our” refer to joshmart.
                        <br>
                        joshmart offers https://shop.joshmart.ai, including all information, tools and services
                    ...
                    <p class="text-white">
                        By visiting our site and/ or purchasing something from https://shop.joshmart.ai,
                        you engage in our “Service” and agree to be bound by the following terms and conditions
                        (“Terms of Service”, “Terms”), including those additional terms and conditions and
                    ...
                    <p class="text-white">
                        ...
                        then you may not access the website or use any services. If these Terms of Service
                    ...
                    <p class="text-white">
                        ...
                        in your state or province of residence and you have given us your consent to allow
                    ...
                    <p class="text-white">
                        ...
                        of the Service, use of the Service, or access to the Service or any contact on the
                    ...
                    <p class="text-white">
                        ...
                        modify the contents of this site at any time, but we have no obligation to update
                        any information on our site. You agree that it is your responsibility to monitor
                        changes to our site.
                    </p>
                    <p class="text-white">
                    ...
                    <p class="text-white">
                        Some products which are currently selling on the portal may belong to the stock
                        lot or stock excess, It may belong to the prior manufacturing year (2019, 2018,
                        or older) some listed products may be out of warranty and packing box and packaging
                        might be damaged. It is advisable to read all terms and conditions or refund policies
                        while buying any product for more clarity.
                    </p>
                    <p class="text-white">
                    ...
                    <p class="text-white">
                        ...
                        for any third-party materials or websites, or for any other materials, products,
                    ...
                    <p class="text-white">
                        ...
                        in our sole discretion are unlawful, offensive, threatening, libellous, defamatory,
                    ...
                    <p class="text-white">
                        ...
                        could in any way affect the operation of the Service or any related website. You
                        ...
                        solely responsible for any comments you make and their accuracy. We take no responsibility
                    ...
                    <p class="text-white">
                        ...
                        or on any related website, including without limitation, pricing information, except
                        as required by law. No specified update or refresh date applied in the Service or
                    ...
                    <p class="text-white">
                        ...
                        the functionality or operation of the Service or of any related website, other websites,
                        or the Internet; (h) to collect or track the personal information of others; (i)
                        to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or
                        immoral purpose; or (k) to interfere with or circumvent the security features of
                        the Service or any related website, other websites, or the Internet. We reserve
                        the right to terminate your use of the Service or any related website for violating
                    ...
                    <p class="text-white">
                        You agree that from time to time we may remove the service/product for indefinite
                    ...
                    <p class="text-white">
                        In no case shall joshmart, our directors, officers, employees, affiliates, agents,
                        ...
                        or damage of any kind incurred as a result of the use of the service or any content
                        (or product) posted, transmitted, or otherwise made available via the service, even
                        if advised of their possibility. Because some states or jurisdictions do not allow
                    ...
                    <p class="text-white">
                        You agree to indemnify, defend and hold harmless joshmart and our parent, subsidiaries,
                        ...
                        or arising out of your breach of these Terms of Service or the documents they incorporate
                    ...
                    <p class="text-white">
                        ...
                        to be severed from these Terms of Service, such determination shall not affect the
                    ...
                    <p class="text-white">
                        ...
                        us. You may terminate these Terms of Service at any time by notifying us that you
                    ...
                    <p class="text-white">
                        ...
                        responsibility to check our website periodically for changes. Your continued use
                        of or access to our website or the Service following the posting of any changes
