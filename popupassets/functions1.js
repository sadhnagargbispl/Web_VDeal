...
(function($) {
	...
	function initialize(obj) {
		...
		var image = "assetsbfapl/images/pointer.png";
	...
	$(document).on("ready", function() {
		...
		if( $('#choose_color').length ) {
			 ...
			 $("#default").on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/default.css");
				return false;
			});
			
			$("#green" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/green.css");
				return false;
			});
			
			$("#red").on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/red.css");
				return false;
			});
			
			$("#orange").on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/orange.css");
				return false;
			});
			
			$("#coral" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/coral.css");
				return false;
			});

			$("#cyan" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/cyan.css");
				return false;
			});

			$("#khaki" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/khaki.css");
				return false;
			});

			$("#pink" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/pink.css");
				return false;
			});

			$("#yellow" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/yellow.css");
				return false;
			});

			$("#gold" ).on("click", function() {
				$("#color" ).attr("href","assetsbfapl/css/color-schemes/gold.css");
				return false;
			});
