...
<html class="no-js" lang="zxx">
  <head>
    ...
    <title>V DEAL  | Hotel Bookings | Movie Bookings | Food Bookings | Online Shopping | Gift Voucher </title>
          ...
          <div class="row justify-content-center mt-4">
            ...
            <div class="col-lg-3 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">               
                  <img src="img/services/food.jpg" alt="banner" class="img-fluid img-responsive w-100">                
            ...
            <div class="col-lg-3 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">
                  <img src="img/services/movie.jpg" alt="banner" class="img-fluid img-responsive w-100">
                <div class="description mt-3 mb-3">
            ...
            <div class="col-lg-3 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">
                  <img src="img/services/holiday.jpg" alt="banner" class="img-fluid img-responsive w-100">
                <div class="description mt-3 mb-3">
            ...
            <div class="col-lg-3 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">
                  <img src="img/services/utility.jpg" alt="banner" class="img-fluid img-responsive w-100">
                <div class="description mt-3 mb-3">
            ...
            <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">
                  <img src="img/services/gv.jpg" alt="banner" class="img-fluid img-responsive w-100">
                <div class="description mt-3 mb-3">
           ...
           <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">
                 <img src="img/services/onlinestore.jpg" alt="banner" class="img-fluid img-responsive w-100">
                <div class="description mt-3 mb-3">
            ...
            <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3 mmb-2">
              <div class="card text-center">                
                <img src="img/services/brandedproducts.jpg" alt="banner" class="img-fluid img-responsive w-100">               
                <div class="description mt-3 mb-3">
